object Challenges {
  ...
  /** Implement applyFunction, which takes a function and a value, and applies
    ...
    */
  def applyFunction[A, B](func: A => B, value: A) = func(value)
  ...
  def getWeatherDescription(condition: WeatherCondition): String =
    ...
    condition match
      case Sunny  => s"It's a sunny day."
      case Cloudy => s"It's a cloudy day."
      case Rainy  => s"It's a rainy day."
      case Snowy  => s"It's a snowy day."
